from src.handlers.output import KlothedBodyV4_1
...
class KlothedV4_1(KlothedBodyV4_1):
    def __init__(self,
        ...
        self.matte_paths = glob.glob(os.path.join(matte_path, '*_silhouette.??g'))\
