try:
    from utils.common import assert_positive
except (ModuleNotFoundError, ImportError) as e:
    from common import assert_positive
...
class Silhouette(torch.nn.Module):
    def __init__(self,        
        ...
        principal_point:    typing.Union[float, typing.Tuple[float, float]]=None, # 0.5,
        width:              int=None,
        height:             int=None,
        rotation:           torch.Tensor=None,
        translation:        torch.Tensor=None,
        z_reflection:       bool=True,
        faces_per_pixel:    int=8, # 1,
        blend_sigma:        float=1e-5, # 1e-7,
        blend_gamma:        float=1e-5, # 1e-7,
