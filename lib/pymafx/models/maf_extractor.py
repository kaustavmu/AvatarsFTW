...
from lib.pymafx.utils.iuvmap import iuv_img2map, iuv_map2img, seg_img2map
...
class Mesh_Sampler(nn.Module):
    ...
    def __init__(self, type='smpl', level=2, device=torch.device('cuda'), option=None):
        ...
        if type == 'flame':
            sampling_idx = torch.LongTensor(list(np.load('/home/adithya/HSL/test/SIFU/data/HPS/pymafx_data/flame_downsampling.npy')))
            ...
            if type == 'smpl':
                ...
                smpl_mesh_graph = np.load('/home/adithya/HSL/test/SIFU/data/HPS/pymafx_data/smpl_downsampling.npz', allow_pickle=True, encoding='latin1')

                A = smpl_mesh_graph['A']
                U = smpl_mesh_graph['U']
                D = smpl_mesh_graph['D'] # shape: (2,)
            elif type == 'mano':
                mano_mesh_graph = np.load('/home/adithya/HSL/test/SIFU/data/HPS/pymafx_data/mano_downsampling.npz', allow_pickle=True, encoding='latin1')
